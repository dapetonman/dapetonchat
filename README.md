...
only the best unsecure non updated chat server for friends!
80% of the backend is completely Ai vibe coded ima be honest with u.
I try to make it myself then it doesnt work so i highlight the code and use ai and it works.
